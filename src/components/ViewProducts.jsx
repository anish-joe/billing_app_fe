                    ...
                    <td>
                      <ButtonGroup>
                        <Button
                          ...
                          onClick={() =>
                            handleIncrease(pdt.productId, pdt.productQuantity)
                          }
                        ></Button>
                        <Button
                          variant="warning"
                          ...
                          onClick={() =>
                            handleDecrease(pdt.productId, pdt.productQuantity)
                          }
                        ></Button>
                      </ButtonGroup>
                    </td>
                      ...
                      <ButtonGroup>
                        {product.productId === pdt.productId ? (
                          ...
                          <Button
                            ...
                            onClick={() => handleEdit(pdt)}
                          ></Button>
                        )}
                        <Button
                          variant="danger"
                          className="bi bi-trash"
                          onClick={() => handleDelete(pdt.productId)}
                        ></Button>
                      </ButtonGroup>
                    </td>
                  </tr>
